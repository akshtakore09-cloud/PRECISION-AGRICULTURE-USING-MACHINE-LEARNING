...
def weather_fetch(city_name):
    """
    Dummy weather function (no API needed)
    Returns stable values so project never fails
    """

    # You can later improve this with real dataset if needed
    temperature = 25.0
    humidity = 60
